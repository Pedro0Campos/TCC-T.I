...
const UIController = (function() {
    ...
    return {
        ...
        createTrackDetail(img, title, artist, time) {
...
const APPController = (function(UICtrl, APICtrl) {
    ...
    DOMInputs.tracks.addEventListener('click', async (e) => {
        ...
        UICtrl.createTrackDetail(track.album.images[2].url, track.name, track.artists[0].name, track.duration_ms / 60000);
    });    
